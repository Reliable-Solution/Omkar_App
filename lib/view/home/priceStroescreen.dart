...
class _SubCategoryScreenState extends State<SubCategoryScreen> {
  ...
  void initState() {
    ...
    _controller.getProductCategoryData(
      widget.categoryId,
      _homeController.customerModel!.value.customerId!,
    );
        ...
        slivers: [
          SliverAppBar(
            ...
            title: TextWiget(
              ...
              style: Themes.light.textTheme.titleMedium?.copyWith(
                color: Colors.black,
          ...
          Obx(() {
            print("=======> ${_controller.categoryProductList.length}");
            return _controller.isCategoryProduct.value
                ...
                : _controller.categoryProductList.isEmpty &&
                      _controller.isCategoryProduct.value == false
                ? SliverToBoxAdapter(
                    child: SizedBox(
                ...
                : SliverGrid(
                    delegate: SliverChildBuilderDelegate((context, index) {
                      ...
                      return Container(
                        ...
                        child: ProductComponent(products: products),
                      );
