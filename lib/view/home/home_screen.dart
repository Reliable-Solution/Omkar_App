...
import 'package:omkar_app/view/account/account_screen.dart';
import 'package:omkar_app/view/coinHistory_screen/coinHistory_screen.dart';
import 'package:omkar_app/view/dashboard/dashboardScreen.dart';
import 'package:omkar_app/view/home/SliverAppBarDelegate.dart';
import 'package:omkar_app/view/home/diseaseScreen.dart';
import 'package:omkar_app/view/leadership%20&%20reward/leadership%20main.dart';
import 'package:omkar_app/view/video_player/video_list_screen.dart';
import 'package:omkar_app/widget/alignWidget.dart';
import 'package:omkar_app/widget/categoryWidget.dart';
...
import 'package:omkar_app/widget/textButtonWidget.dart';
      ...
      child: Scaffold(
        ...
        body: GetBuilder<HomeController>(
          builder: (controller) {
            ...
            return controller.offerList.isEmpty
                ? SizedBox()
                : RefreshIndicator(
                    onRefresh: () async {
                ...
                _drawerTile(
                  ...
                  voidCallback: () {
                    ...
                    if (box != null) {
                      ...
                      debugPrint("Share Position Origin: $sharePositionOrigin");
                      try {
                        Share.share(
                      ...
                      debugPrint(
                        "Error: Could not find RenderBox for context.",
                      );
